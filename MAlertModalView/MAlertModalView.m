...
#import "MAlertModalView.h"

@implementation MAlertModalView
{
    UIView *dialogView;
...
+ (MAlertModalView *)showAlertModalView:(UIView *)modalView
                        leftButtonTitle:(NSString *)leftButtonTitle
                       rightButtonTitle:(NSString *)rightButtonTitle
                             completion:(void (^)(NSInteger buttonIndex))completion
{
    UIWindow *window = [[UIApplication sharedApplication] delegate].window;
    MAlertModalView *mAlertModalView =[[self alloc] initAlertModalView:(UIView *)modalView
                                                       leftButtonTitle:leftButtonTitle
                                                      rightButtonTitle:rightButtonTitle
                                                            completion:(void (^)(NSInteger))completion];
    mAlertModalView.frame = CGRectMake(0, 0, window.frame.size.width, window.frame.size.height);
    [window addSubview:mAlertModalView];
    
    [mAlertModalView show];
    
    return mAlertModalView;
}
