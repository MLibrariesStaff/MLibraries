...
#define MALERT_BUTTON_HEIGHT 50
                   ...
                   completion:(void (^)(NSInteger buttonIndex))completion
{
    ...
    CGFloat dialogHeight = 70.0;
    CGFloat titleLabelMargin = 10;
    CGFloat titleLabelHeight = dialogHeight - MALERT_BUTTON_HEIGHT;
    
    UIView *bgView = [[UIView alloc] init];
    bgView.frame = CGRectMake(0, 0, dialogWidth, dialogHeight);
    ...
    CGRect titleLabelFrame = [string boundingRectWithSize:CGSizeMake(titleLabel.frame.size.width, 1500)
                                                  options:NSStringDrawingUsesLineFragmentOrigin
                                                  context:nil];
    
    if (titleLabelFrame.size.height + titleLabelMargin*2 > titleLabelHeight) {
        titleLabelHeight = titleLabelFrame.size.height + titleLabelMargin*2;
        CGRect frame = titleLabel.frame;
        frame.size.height = titleLabelHeight;
        [titleLabel setFrame:frame];
        
        bgView.frame = CGRectMake(0, 0, dialogWidth, titleLabelHeight + titleLabelMargin*2);
    }

    return [MAlertView showAlertModalView:bgView
...
- (void)setView
{
    ...
    dialogView.backgroundColor     = [UIColor colorWithRed:0.992 green:0.992 blue:0.980 alpha:0.98]; // #fdfdfa
    ...
    // ダイアログの高さを調整
    CGFloat dialogHeight = _modalView.frame.size.height + MALERT_BUTTON_HEIGHT;
    ...
    leftButton.frame = CGRectMake(0, dialogView.frame.size.height - MALERT_BUTTON_HEIGHT, buttonWidth, MALERT_BUTTON_HEIGHT);
    ...
    if (_rightButtonTitle != nil) {
        ...
        rightButton.frame = CGRectMake(buttonWidth, dialogView.frame.size.height - MALERT_BUTTON_HEIGHT,
                                       buttonWidth, MALERT_BUTTON_HEIGHT);
